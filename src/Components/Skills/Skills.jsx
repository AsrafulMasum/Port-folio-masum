  ...
  return (
    ...
    whileInView="animate" className="max-w-[1080px] mx-auto mt-10 md:mt-20">
      ...
      <motion.div variants={textVariants} className="flex flex-wrap justify-center gap-12">
        {
          skills.map((skill, idx) => <motion.p key={idx} variants={textVariants} className="border border-gray-600 text-white px-12 py-4 inline-block rounded-sm hover:bg-[#D3D3D3] hover:text-black group"><p className="group-hover:scale-125 duration-1000">{skill}</p></motion.p>)
        }
