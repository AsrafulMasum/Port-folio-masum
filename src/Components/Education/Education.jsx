  ...
  return (
    <div className="max-w-[1080px] mx-auto mt-16 flex flex-col lg:flex-row gap-10">
      ...
      <div className=" flex-1">
        <h2 className="text-center text-7xl mb-4">Education</h2>
        <div className="space-y-4">
          <div className="flex flex-col gap-2 bg-slate-500 px-8 py-4 rounded-sm hover:scale-x-110 duration-1000 text-white">
          ...
          <div className="flex flex-col gap-2 bg-slate-500 px-8 py-4 rounded-sm hover:scale-110 duration-1000 text-white">
